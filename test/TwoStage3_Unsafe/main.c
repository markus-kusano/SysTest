...
void *funcA(void *param) {
    ...
    // there is a benign data race in this critical section between other
    // functions in funcA. Specifically, the read on data1Value below races
    // with the write of data1Value above. However, the write is always 1 so
    // the read will always get the same value.
...
int main(int argc, char *argv[]) {
    ...
    // By default: 2 iT threads and 1 iR thread
