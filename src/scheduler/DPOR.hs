...
--
-- Scheduling functions for DPOR
module DPOR (dporBegin)  where 
...
-- Main entry point for DPOR scheduler.
--
-- Sets up sockets to communicate with program under test and starts exploration
dporBegin :: Options -> IO () 
dporBegin opts  = withSocketsDo $ do 
